-- Script para importação dos clientes da RDS IMOBILIÁRIA (CORRIGIDO)
-- Data: $(date)
-- Total de clientes: 46
...
-- 11. ANILTON MARQUES / LUZIETH FARIAS (CPF fake)
(
...
-- 12. PATRICK JEHMERSON GOMES DE ALMEIDA (CPF fake)
(
