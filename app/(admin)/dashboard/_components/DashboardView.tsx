  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button variant={period === '6mo' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('6mo')}>6mo</Button>
        <Button variant={period === '1yr' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('1yr')}>1 ano</Button>
        <Button variant={period === 'last-year' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('last-year')}>Ano passado</Button>
        <Button variant={period === 'custom' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('custom')}>Personalizado</Button>
      </div>

      <div className="flex flex-wrap items-center gap-2 mt-2">
        <span className="text-sm text-gray-400 mr-2">Filtrar por ano:</span>
        <Button variant={period === 'year-2021' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('year-2021')}>2021</Button>
        <Button variant={period === 'year-2022' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('year-2022')}>2022</Button>
        <Button variant={period === 'year-2023' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('year-2023')}>2023</Button>
        <Button variant={period === 'year-2024' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('year-2024')}>2024</Button>
        <Button variant={period === 'year-2025' ? 'default' : 'secondary'} size="sm" onClick={() => setPeriod('year-2025')}>2025</Button>
      </div>
