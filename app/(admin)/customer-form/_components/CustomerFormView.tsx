...
export type CustomerFormViewProps = { id?: number };

export default function CustomerFormView({ id }: CustomerFormViewProps) {
      ...
      case 'dados-pessoais':
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-300">{formData.tipoPessoa === 'pf' ? 'CPF *' : 'CNPJ *'}</label>
              <input
